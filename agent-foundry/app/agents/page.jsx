...
const AGENTS = [
  ...
  },
  {
    ...
    icon: HiOutlineBeaker,
    color: "from-indigoSoft to-blurple-500",
    status: "active",
  },
  {
    id: "imaging",
...
const MOCK_MESSAGES = [
  ...
  },
  {
    ...
    from: "treatment",
    to: "emergency",
    action: "CHECK_EMERGENCY_CRITERIA",
  ...
  },
  {
    ...
    timestamp: Date.now() - 3000,
    data: { modality: "X-ray", region: "chest" },
  },
  {
    id: 6,
    from: "treatment",
  ...
  },
  {
    ...
    action: "PUBLISH_HASH",
    timestamp: Date.now() - 1000,
    data: { recordType: "diagnosis+treatment" },
  },
];
...
export default function AgentsPage() {
  ...
  // Simulate real-time message updates (heartbeat from Patient → Diagnostic)
  useEffect(() => {
    const interval = setInterval(() => {
      const newMessage = {
        id: Date.now(),
      ...
      setMessages((prev) => [...prev, newMessage].slice(-12));
    }, 10000);
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={`flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br ${
                      fromAgent?.color || "from-slate-700 to-slate-800"
                    } shadow-md`}
                  >
                    {fromAgent && (
                      <fromAgent.icon className="h-4 w-4 text-slate-50" />
                    )}
                  </div>
                  <span className="text-xs text-slate-400">
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={`flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br ${
                      toAgent?.color || "from-slate-700 to-slate-800"
                    } shadow-md`}
                  >
                    {toAgent && (
                      <toAgent.icon className="h-4 w-4 text-slate-50" />
                    )}
                  </div>
                  <span className="text-xs text-slate-400">
                    {toAgent?.name || "Unknown"}
                  </span>
                </div>
